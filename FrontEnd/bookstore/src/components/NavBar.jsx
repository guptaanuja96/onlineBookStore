                        ...
                        <li className="nav-item active " >
                            <Dropdown title="Category" icon={<MenuIcon />} appearance="subtle">
                                <Dropdown.Menu title="Fiction">
                                    <Dropdown.Item><Link className="dropdown-item" to="/cat/Men/Upper Wear">English</Link></Dropdown.Item>
                                    <Dropdown.Item><Link className="dropdown-item" to="/cat/Men/Bottom Wear">Hindi</Link></Dropdown.Item>
                                </Dropdown.Menu>
