...
function MyProducts() {
    ...
    useEffect(() => {
        axios.get("http://localhost:8080/api/books?sellerid=" + sellerid)
            .then(resp => {
    ...
    const deleteProduct = (prodid) => {
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    axios.delete("http://localhost:8080/api/books/" + prodid)
                        .then(resp => {
                            swal({
                                title: "Success",
                            ...
                            <TableBody>
                                {products.map(x => (
                                    <StyledTableRow key={x.prodid}>
                                        ...
                                        <StyledTableCell align="center">{x.bauthor}</StyledTableCell>
