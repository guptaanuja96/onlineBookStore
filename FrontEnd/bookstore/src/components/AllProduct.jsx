...
function AllProduct() {
    ...
    const loadDataFromServer = (page = 0, pagesize = 8) => {
        axios.get("http://localhost:8080/api/books/paginated?page=" + page + "&pagesize=" + pagesize)
            .then(resp => {
    ...
    useEffect(() => {
        ...
        if (pcat !== undefined) {
            axios.get("http://localhost:8080/api/books/cats?cat=" + pcat + "&subcat=" + subcat)
                .then(resp => {
    ...
    return (
        <>
            ...
            <div className="container-fluid" style={{ width: "92%" }}>
                <div className="card shadow rounded bg">
                                ...
                                <div className="modal-body">
                                    <div className="d-flex">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <h5 className="px-2">Author: {item.bauthor}</h5>
